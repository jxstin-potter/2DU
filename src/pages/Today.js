...
var Today = function () {
    ...
    var _b = useTaskModal(), isTaskModalOpen = _b.isOpen, closeTaskModal = _b.closeModal;
    ...
    var handleTaskToggle = function (taskId) { return __awaiter(void 0, void 0, void 0, function () {
        var task, completed, taskDoc, Timestamp, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    error_2 = _a.sent();
                    setError(error_2 instanceof Error ? error_2.message : 'Failed to toggle task status');
                    return [3 /*break*/, 5];
    ...
    var handleTaskUpdate = function (taskId, updates) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    error_4 = _b.sent();
                    setError(error_4 instanceof Error ? error_4.message : 'Failed to update task');
                    return [3 /*break*/, 5];
                case 5: return [2 /*return*/];
            }
        });
    ...
    var handleCreateTask = function (taskData) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error_5 = _a.sent();
                    errorMessage = error_5 instanceof Error ? error_5.message : 'Failed to create task';
                    setError(errorMessage);
                    console.error('Failed to create task:', error_5);
                    throw error_5;
    ...
    if (loading) {
        return (_jsx(Container, { maxWidth: "lg", children: _jsx(Box, { display: "flex", justifyContent: "center", alignItems: "center", minHeight: "200px" }) }));
    }
    return (_jsx(Box, { sx: {
            display: 'flex',
